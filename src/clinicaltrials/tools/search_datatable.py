            ...
            with Column(gap=4, css_class="p-6"):
                ...
                DataTable(
                    columns=[
                        ...
                        DataTableColumn(key="title", header="Title", sortable=True, max_width="400px", cell_class="truncate"),
                        DataTableColumn(key="status", header="Status", sortable=True),
                        DataTableColumn(key="phase", header="Phase", sortable=True),
                        DataTableColumn(key="conditions", header="Conditions", sortable=False, max_width="400px", cell_class="truncate"),
                        DataTableColumn(key="interventions", header="Interventions", sortable=False, max_width="400px", cell_class="truncate"),
