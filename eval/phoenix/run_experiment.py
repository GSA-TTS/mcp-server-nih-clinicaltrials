...
Usage:
    uv run eval/phoenix/run_experiment.py --dataset-name clinicaltrials-test-0
    uv run eval/phoenix/run_experiment.py --dataset-name clinicaltrials-test-0 --system-prompt-version v01
    uv run eval/phoenix/run_experiment.py --dataset-name clinicaltrials-test-0 --experiment-description "Testing new prompt"
"""
...
from agent import NIHClinicalTrialsAgent
...
def main(
    ...
    system_prompt_version: str = "v01",
    project_name: str = "nih-clinicaltrials-experiments",
    ...
    """
    Run a Phoenix experiment with the ClinicalTrials agent.
    ...
    try:
        ...
        print(f"Initializing NIHClinicalTrials agent with prompt {system_prompt_version}...")
        agent = NIHClinicalTrialsAgent(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Phoenix experiments with NIH Clinical Trials agent",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run experiment with default settings
  python run_experiment.py --dataset-name clinicaltrials-test-0
  
  # Test different system prompt versions
  python run_experiment.py --dataset-name clinicaltrials-test-0 --system-prompt-version v01
  
  # Add custom description and metadata
  python run_experiment.py --dataset-name clinicaltrials-test-0 \\
      --experiment-description "Testing boundary detection" \\
      --system-prompt-version v01
  ...
  python run_experiment.py --dataset-name clinicaltrials-test-0 \\
    ...
    parser.add_argument(
        "--project-name",
        type=str,
        default="nih-clinicaltrials-experiments",
