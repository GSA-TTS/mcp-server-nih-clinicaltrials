...
class NIHClinicalTrialsAgent:
    ...
    def __init__(self, project_name="nih-clinicaltrials-agent", phoenix_endpoint="http://localhost:4317", prompt_version="v01"):
    ...
    def create_experiment_task(self):
        ...
        """
        def task(example):
            """Run each query through the NIH ClinicalTrials.gov agent"""
